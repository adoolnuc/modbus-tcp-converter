	...
	; Compiler options:
	;
	; -oTCP_Convert.cof -mTCP_Convert.map --summary=default \
	; --output=default TCP_Convert_main.p1 TCP_Convert_PORT_Init.p1 \
	; TCP_Convert_Uart.p1 TCP_Convert_EEPROM.p1 TCP_Convert_W5200.p1 \
	; uart.p1 TCP_Convert_Comm.p1 modbus.p1 --chip=18F25K22 -P \
	; --runtime=default --opt=default -D__DEBUG=1 --debugger=pickit3 -g \
